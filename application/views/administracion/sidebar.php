		...
		<ul class="navbar-nav bg-primary sidebar sidebar-dark accordion text-capitalize" id="accordionSidebar">
			...
			?>
				...
				<li class="nav-item">
					...
					<div id="collapseShop" class="collapse" aria-labelledby="headingContents" data-parent="#accordionSidebar">
						<div class="bg-white py-2 collapse-inner rounded">
							<h6 class="collapse-header"><?= lang('modules') ?></h6>
							<a class="collapse-item" href="<?= base_url('Admin/ordenes') ?>"><?= lang('orders') ?></a>
							<?Php
							if ($admin == 1 || $admin == 2) {
							?>
								<a class="collapse-item" href="<?= base_url('Admin/facturas') ?>"><?= lang('bills') ?></a>
							<?Php
							};
							?>
						</div>
			...
			<!-- de aqui en adelante se muestran los menu con permiso de usuarios simples o empleados -->
			<?Php
			if ($admin == 3) {
			?>
				<!-- Nav Item - Administración Collapse Menu -->

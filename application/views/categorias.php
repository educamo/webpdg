 ...
 <div class="container-fluid">
     ...
     <div class="card shadow mb-4">
         <div class="card-header py-3">
             <h6 class="m-0 font-weight-bold text-primary"><?= lang('list-category') ?></h6>
         </div>
         <div class="row">
             <div class="col-md-12 text-end mr-5 pr-4">
                 <!-- Button trigger modal -->
                 <button type="button" class="btn btn-default btn-primary mt-3">
                     <?= lang('new-category') ?><i class="fa fa-plus-circle"></i>
                 </button>
             </div>
         </div>
         <div class="card-body">
                     ...
                     <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                         <thead>
                             <tr>
                                 ...
                                 <th><?= lang('categoryDescription') ?></th>
                                ...
                                ?>
                                 <tr>
                                     ...
                                     <td class="text-center">
                                         <a href="<?= base_url() ?>Admin/actualizarcategory/<?= $category->categoryId ?>" class="btn btn-warning text-ligth"> <i class="fa fa-edit"></i></a>
                                         <button type="button" class="btn btn-danger text-light delete" name="delete" data-id="<?= $category->categoryId ?>"><i class="fa fa-trash"></i></button>
                                     </td>
                                 </tr>
                             <?Php
                                }
 ...
 <script>
     $(document).ready(function() {
         ...
         $('.btn-primary').click(function() {
             location.href = urlbase + 'Admin/nuevocategory';
         });
         ...
         $('.delete').click(function(e) {
             ...
             alertify.confirm('<?= lang('confirm-message') ?>',
                 function() {
                     ...
                     var urlajax = urlbase + "Admin/borrarcategory";
                     // Run $.ajax() here

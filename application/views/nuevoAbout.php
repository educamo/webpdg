 ...
 <div class="container-fluid">
     ...
     <div class="card shadow mb-4">
         <div class="card-header py-3">
             <h6 class="m-0 font-weight-bold text-primary"><?= lang('new-about') ?></h6>
         </div>
         <div class="card-body">
             <form action="#" method="post" id="frmNewabout">
                 <div class="row">
                     <div class="col-md-4 mb-2">
                         <label for="aboutId" class="form-label"><?= lang('aboutId') ?></label>
                         <input type="text" id="aboutId" name="aboutId" class="form-control" maxlength="10" required autofocus>
                     </div>
                     <div class="col-md-4 mb-2">
                         <label for="aboutTitle" class="form-label"><?= lang('aboutTitle') ?></label>
                         <input type="text" id="aboutTitle" name="aboutTitle" class="form-control" maxlength="100" required>
                     </div>
                     <div class="col-md-4 mb-2">
                         <label for="aboutDescription" class="form-label"><?= lang('aboutDescription') ?></label>
                         <textarea type="text" id="aboutDescription" name="aboutDescription" class="form-control" maxlength="250" required></textarea>
                     </div>
                     <div class="col-md-4 mb-2">
 ...
 <script>
     $(document).ready(function() {
         ...
         $("#frmNewabout").submit(function(event) {
             // Prevent the form from submitting
             event.preventDefault();


             //creo variable con la url del ajax
             var urlajax = urlbase + "Admin/guardarAbout";
             // Run $.ajax() here
             ...
             $.ajax({
                 ...
                 data: $("#frmNewabout").serializeArray(),

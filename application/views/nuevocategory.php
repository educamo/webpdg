 ...
 <div class="container-fluid">
     ...
     <div class="card shadow mb-4">
         <div class="card-header py-3">
             <h6 class="m-0 font-weight-bold text-primary"><?= lang('new-category') ?></h6>
         </div>
         <div class="card-body">
             <form action="#" method="post" id="frmNewcategory">
                 <div class="row">
                     <div class="col-md-4 mb-2">
                         <label for="categoryId" class="form-label"><?= lang('categoryId') ?></label>
                         <input type="text" id="categoryId" name="categoryId" class="form-control" maxlength="10" required autofocus>
                     </div>
                     <div class="col-md-4 mb-2">
                         <label for="categoryName" class="form-label"><?= lang('categoryName') ?></label>
                         <input type="text" id="categoryName" name="categoryName" class="form-control" maxlength="100" required>
                     </div>
                     <div class="col-md-4 mb-2">
                         <label for="categoryDescription" class="form-label"><?= lang('categoryDescription') ?></label>
                         <textarea type="text" id="categoryDescription" name="categoryDescription" class="form-control" maxlength="250" required></textarea>
                     </div>
                 </div>
                 <div class="row mt-4">
 ...
 <script>
     $(document).ready(function() {
         ...
         $("#frmNewcategory").submit(function(event) {
             ...
             var urlajax = urlbase + "Admin/guardarCategoria";
             // Run $.ajax() here
             ...
             $.ajax({
                 ...
                 data: $("#frmNewcategory").serializeArray(),

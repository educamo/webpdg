...
<!-- //TODO: falta terminar el modulo de proyectos -->
     ...
     <div class="card shadow mb-4">
         <div class="card-header py-3">
             <h6 class="m-0 font-weight-bold text-primary"><?= lang('list-project') ?></h6>
         </div>
         <div class="row">
             <div class="col-md-12 text-end mr-5 pr-4">
                 <!-- Button trigger modal -->
                 <button type="button" class="btn btn-default btn-primary mt-3">
                     <?= lang('new-project') ?><i class="fa fa-plus-circle"></i>
                 </button>
             </div>
         </div>
         <div class="card-body">
             <div class="container-fluid">
                 <div class="table-responsive">
                     <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                         <thead>
                             <tr>
                                 <th style="width: 300px;"><?= lang('projectTitle') ?></th>
                                 <th><?= lang('projectImagenpreview') ?></th>
                             ...
                             <?Php
                                ...
                                ?>
                                 <tr>
                                     ...
                                     <td><div class="text-center"><img src="<?= base_url('assets/img/') . $project->projectImagen ?>" alt="<?= $project->projectImagen ?>" class="img-fluid img-responsive img-thumbnail w-50"></div></td>
                                     <td><?= $activo ?></td>
                                     <td class="text-center">
                                         <a href="<?= base_url() ?>Admin/actualizarproject/<?= $project->projectId ?>" class="btn btn-warning text-ligth"> <i class="fa fa-edit"></i></a>
                                         <button type="button" class="btn btn-danger text-light delete" name="delete" data-id="<?= $project->projectId ?>"><i class="fa fa-trash"></i></button>
                                     </td>
                                 </tr>
                             <?Php
                                }
 ...
 <script>
     $(document).ready(function() {
         ...
         $('.btn-primary').click(function() {
             location.href = urlbase + 'Admin/nuevoproject';
         });
         ...
         $('.delete').click(function(e) {
             ...
             alertify.confirm('<?= lang('confirm-message') ?>',
                 function() {
                     ...
                     var urlajax = urlbase + "Admin/borrarproject";
                     // Run $.ajax() here

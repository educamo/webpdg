 ...
 <div class="container-fluid">
     ...
     <div class="card shadow mb-4">
         ...
         <div class="card-body">
             <div class="container-fluid">
                 <form action="#" method="POST" enctype="multipart/form-data" id="frmModproject">
                     <div class="row">
                         <div class="col-md-4">
                             <label for="projectId" class="form-label"><?= lang('projectId') ?></label>
                             <input type="text" id="projectId" name="projectId" class="form-control" maxlength="10" value="<?= $projectId ?>" required>
                             <input type="hidden" id="Id" name="Id" class="form-control" maxlength="10" value="<?= $projectId ?>" required>
                         </div>
                         <div class="col-md-4">
                             <label for="projectTitle" class="form-label"><?= lang('projectTitle') ?></label>
                             <input type="text" id="projectTitle" name="projectTitle" class="form-control" maxlength="100" value="<?= $projectTitle  ?>" required>
                         </div>
                         <div class="col-md-4">
                             <label for="projectDescription" class="form-label"><?= lang('projectDescription') ?></label>
                             <textarea name="projectDescription" id="projectDescription" cols="30" rows="4" class="form-control" maxlength="250" required><?= $projectDescription ?></textarea>
                         </div>
                         ...
                         <div class="col-md-7 mt-4">
                             ...
                             <input type="hidden" name="imagenVieja" id="imagenVieja" value="<?= $projectImagen ?>" required>
                         </div>
                         <div class="col-md-3 mt-4">
                             <div id="preview"><img src="<?= base_url('assets/img/') . $projectImagen ?>" class=" img-fluid img-thumbnail" width="306" height="360"></div>
                         </div>
                     </div>
                     <div class="row mt-5">
 ...
 <script>
     $(document).ready(function() {
          ...
          *
          */
         $("#frmModproject").submit(function(event) {
             // Prevent the form from submitting
             event.preventDefault();

             var formData = new FormData($("#frmModproject")[0]);

             //creo variable con la url del ajax
             var urlajax = urlbase + "Admin/modificarPoject";
             // Run $.ajax() here

 ...
 <div class="container-fluid">
     ...
     <div class="card shadow mb-4">
         <div class="card-header py-3">
             <h6 class="m-0 font-weight-bold text-primary"><?= lang('mod-service') ?></h6>
         </div>
         <div class="card-body">
             <div class="container-fluid">
                 <form action="#" method="POST" enctype="multipart/form-data" id="frmModservice" name="frmModservice" class="needs-validation">
                     <div class="row">
                         <div class="col-md-2">
                             <label for="serviceId" class="form-label"><?= lang('serviceId') ?></label>
                             <input type="text" id="serviceId" name="serviceId" class="form-control" maxlength="10" value="<?= $serviceId ?>" required>
                             <input type="hidden" id="Id" name="Id" class="form-control" maxlength="10" required value="<?= $serviceId ?>">
                         </div>
                         <div class="col-md-4">
                             <label for="serviceTitle" class="form-label"><?= lang('serviceTitle') ?></label>
                             <input type="text" id="serviceTitle" name="serviceTitle" class="form-control" maxlength="100" value="<?= $serviceTitle ?>" required>
                         </div>
                         <div class="col-md-4">
                             ...
                             <select name="categoryId" id="categoryId" class="form-select" required>
                                 ...
                                 <?Php
                                    ...
                                    ?>
                                     <option value="<?= $category->categoryId ?>" <?php if($categoryId == $id){echo "selected"; } ?>><?= $category->categoryName ?></option>
                                 <?Php
                                    }
                                    ?>
                             </select>
                         ...
                         <div class="col-md-2">
                             ...
                             <input type="number" name="servicePrice" id="servicePrice" class="form-control" step="0.01" min="0" minlength="1" maxlength="10" pattern="[0-9]+\.\d\S" value="<?= $servicePrice ?>" required>
                         </div>
                         ...
                         <div class="col-md-4">
                             ...
                             <textarea name="serviceDescription" id="serviceDescription" cols="30" rows="4" class="form-control" maxlength="150" required><?= $serviceDescription ?></textarea>
                         </div>
                         <div class="col-md-6 mt-4">
                             ...
                             <input type="hidden" name="imagenVieja" id="imagenVieja" class="form-control" value="<?= $serviceImagen ?>" required>
                         </div>
                         <div class="col-md-12 text-end">
                             <div id="preview"><img src="<?= base_url('assets/img/').$serviceImagen ?>" class="img-fluid img-thumbnail" width="200" height="125"></div>
                         </div>
                     </div>
                     <div class="row mt-5">
 ...
 <script>
     $(document).ready(function() {
         ...
         $(function() {
             ...
             $("form[name='frmModservice']").validate({
                 ...
                 submitHandler: function(form) {
                     var formData = new FormData($("#frmModservice")[0]);

                     //creo variable con la url del ajax
                     var urlajax = urlbase + "Admin/updateService";
                     // Run $.ajax() here
